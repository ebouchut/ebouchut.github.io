...
<div markdown style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5em;">
...
<details markdown>
<summary>Earlier experience: 1991 — 2009</summary>
...
```mermaid
timeline
    title Education, qualifications and certifications

    section Initial education
        1987 – 1989 : Two-year Computer Science Diploma (IUT Aix Marseille)
        1989 – 1990 : University Diploma in HCI and Networks (Université Aix Marseille)
    section Career changes and specialisations
        March – May 2010 : Web Developer programme (Mach3) : Web Developer certification
        Oct 2020 – May 2021 : Blockchain Developer programme (Alyra) : Blockchain Developer certification
    section Recent upskilling
        March – June 2024 : Cybersecurity Developer programme (M2i) : Python certification (TOSA) : English certification (EFSET)
        June 2025 – Oct 2026 : Web and Mobile Web Developer programme (La Plateforme) : Web and Mobile Web Developer certification RNCP-37674
```
